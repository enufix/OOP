/*
Да се развие класа Poligon која ќе претставува полигонална дво-дименнзионална слика  во правоаголен кооординатен систем. Сликата е претставена како множество од темиња (точки) на полигонот (динамички алоцирана листа). Калсата трега да овозможува поместување на фигурата по двете оски одеднас како и пресметка на периметарот на сликата. Да се преоптоварат релационите оператори ==, !=, < и >= кои ќе споредуваат два полигони според вредностите на периметарот.
*/
#include <iostream>
#include <cmath>
using namespace std;
