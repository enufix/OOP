...
public:
    BreakfastHotelReservation(const char *name, int days, int persons): HotelReservation(name, days, persons) {
    }
...
int main() {
    ...
    HotelReservation *hr2 = new BreakfastHotelReservation("Risto Ristovski", 5, 5);
